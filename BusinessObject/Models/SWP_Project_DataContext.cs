...
{
    public partial class SWP_Project_DataContext : DbContext
    {
        public SWP_Project_DataContext()
        {
        }

        public SWP_Project_DataContext(DbContextOptions<SWP_Project_DataContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<RefreshToken>(entity =>
            {
                ...
                entity.HasOne(d => d.Account)
                    ...
                    .HasConstraintName("fk_acc_token");
            });
